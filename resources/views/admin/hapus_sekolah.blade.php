...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto ps" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="/tambah_sekolah">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" fill="evenodd" weight="40" height="40">
            ...
            <span class="nav-link-text ms-2">Tambah Sekolah</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  " href="/sign_up_admin">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm "><a class="opacity-5 text-dark" href="/tambah_sekolah">Tambah Sekolah</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Hapus Sekolah</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Hapus Sekolah</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
            <form action="/hapus_sekolah" method="GET">
              ...
              <ul class="dropdown-menu  dropdown-menu-end  px-2 py-3 me-sm-n4" aria-labelledby="dropdownMenuButton">
                ...
                <li class="mb-2">
                  <a class="dropdown-item border-radius-md" href="javascript:;">
                    <div class="d-flex py-1">
                      <div class="my-auto">
                        <img src="{{asset('aassets/img/small-logos/logo-spotify.svg')}}" class="avatar avatar-sm bg-gradient-dark  me-3 ">
                      </div>
                      <div class="d-flex flex-column justify-content-center">
                        <h6 class="text-sm font-weight-normal mb-1">
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-1000">Id Sekolah</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-1000 ">Nama Sekolah</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-1000">Alamat Sekolah</th>
                      <th class="text-center text-uppercase text-secondary text-xs font-weight-bolder opacity-1000">Action</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach($data as $row)
                    <tr>
                      ...
                      <input class="form-check-input" type="checkbox" data-id="{{$row->id}}" data-nama="{{$row->id}}">
                    </div>
                        <span class="text-xm font-weight-bolder">{{$row->id}}</span>
                      </td>
                      <td class="align-middle text-center">
                        <span class="text-xm font-weight-bolder">{{$row->nama}}</span>
                      </td>
                      <td class="align-middle text-center">
                        <p class="text-xm font-weight-bold">{{$row->alamat}}</p>
                      </td>
                      <td class="align-middle text-center">
                        <a href="#" class="btn bg-gradient-danger delete" data-id="{{$row->id}}" data-nama="{{$row->id}}">Delete</a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
    ...
    <script>
      $('.delete').click(function() {
        var sekolahid = $(this).attr('data-id');
        ...
        swal({
          ...
          .then((willDelete) => {
            if (willDelete) {
              window.location = "/delete_sekolah/" + sekolahid + ""
