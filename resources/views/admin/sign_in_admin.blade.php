        ...
        <ul class="navbar-nav mx-auto ms-xl-auto me-xl-7">
          ...
          <li class="nav-item">
            <a class="nav-link me-2" href="/about">
              <i class="fas fa-key opacity-6 text-dark me-112"></i>
              About
            </a>
          </li>
        </ul>
            ...
            <div class="card z-index-0">
              <div class="card-header text-center pt-2">
                ...
                <div class="nav-wrapper position-relative end-0">
                  <ul class="nav nav-tabs nav-fill p-1" role="tablist">
                    ...
                    <li class="nav-item">
                      <a class="nav-link mb-0 px-0 py-1" href="/sign_in_guru" role="tab" aria-controls="Guru" aria-selected="false">
                        Guru
                      </a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link active mb-0 px-0 py-1" href="/sign_in_admin" role="tab" aria-controls="Admin" aria-selected="true">
                        Admin
                      </a>
                    </li>
                  </ul>
              ...
              <div class="card-body">
                <form action="/sign_in_prosesadmin" method="post">
                  ...
                  <div class="mb-3">
                    <input type="password" class="form-control" placeholder="Password" name="password" aria-label="Password" aria-describedby="password-addon" id="myInput">
                  </div>
                  ...
                  <p class="text-sm mt-3 mb-0">Dont have an account? <a href="/sign_up_admin" class="text-dark font-weight-bolder">Sign up</a></p>
                </form>
              </div>
            </div>
          </div>
