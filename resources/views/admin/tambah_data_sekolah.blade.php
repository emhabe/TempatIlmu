...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
  ...
  <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Data Sekolah</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Data Sekolah</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="card mt-3 col-lg-9" style="margin-left:30px;">
       
          <form action="/insert_sekolah" method="post" enctype="multipart/form-data">
            @csrf
            <div class="mt-3">
              <label for="example-text-input" class="form-control-label">Nama Sekolah :</label>
              <input class="form-control" type="text" value="" id="nama" name="nama" required placeholder="Masukkan Nama Sekolah">
            </div> 
            <div class="mt-3">
              <label for="exampleFormControlTextarea1">Alamat Sekolah :</label>
              <textarea class="form-control" id="alamat" name="alamat" rows="0" required placeholder="Masukkan Alamat Sekolah"></textarea>
            </div>
            <div class="mt-3">
              <label for="formFile" class="form-label">Foto :</label>
              <input class="form-control" type="file" id="foto" name="foto" required placeholder="Masukkan Foto Sekolah">
            </div>
