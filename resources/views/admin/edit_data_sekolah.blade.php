...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Data Sekolah</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Data Sekolah</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-9">
          <form action="/update_sekolah/{{$data->id}}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="form-group" hidden>
              <label for="example-text-input" class="form-control-label">ID Sekolah</label>
              <input class="form-control" type="text" value="{{$data->id}}" id="id" name="id">
            </div>
            ...
            <div class="mb-3">
              ...
              <img src="{{asset('fotosekolah/'.$data->foto)}}" alt="" style="width: 80px;">
