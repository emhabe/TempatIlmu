...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto ps" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  " href="/tambah_sekolah">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Tambah Sekolah</span>
          </a>
        </li>
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="/profile_admin">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <div class="row gx-4">
          <div class="col-auto">
            <div class="avatar avatar-xl position-relative">
              <img src="{{asset ('foto_admin/' .Auth::user()->foto)}}" alt="profile_image" class="w-100 border-radius-lg shadow-sm">
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
            <div class="nav-wrapper position-relative end-0">
              <ul class="nav nav-pills nav-fill p-1 bg-transparent" role="tablist">
                <li class="nav-item">
                  <a class="nav-link mb-0 px-0 py-1" href="/profile_admin" role="tab" aria-selected="false">
                ...
                <div class="moving-tab position-absolute nav-link" style="padding: 0px; width: 140px; transform: translate3d(129px, 0px, 0px); transition: all 0.5s ease 0s;">
                  <a class="nav-link mb-0 px-0 py-1 active " href="../admin/profile.html" role="tab" aria-selected="true">-</a>
                </div>
              </ul>
            </div>
          </div>
        ...
        <div class="col-12 col-xl-8">
          <div class="card h-100">
            ...
            <div class="card-body p-3">
              <form action="/update_profile_admin" method="post" enctype="multipart/form-data">
                @csrf
                <div class="form-group">
                  <label for="exampleFormControlInput1">Foto Profile:</label>
                  <p><img src="{{asset ('foto_admin/' .Auth::user()->foto)}}" width="60px" class="mt-1">
                ...
                <div class="form-group"> <button type="submit" class="btn bg-gradient-primary">Simpan</button></div>
