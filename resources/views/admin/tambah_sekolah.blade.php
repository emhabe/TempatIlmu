      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Sekolah</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Sekolah</h6>
        </nav>
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <div class="input-group">
              <form action="/tambah_sekolah" method="GET">
    ...
    <div class="container-fluid py-4">
      <div class="row">
        ...
        <div>
          ...
          <a href="/tambah_data_sekolah" type="button" class="btn bg-gradient-primary mt-5 mx-4">Tambah Sekolah
            <span class="btn-inner--icon"><i class="ni ni-fat-add"></i></span>
          </a>
          <a href="/hapus_sekolah" type="button" class="btn bg-gradient-danger mt-5">Hapus Sekolah
        ...
        <div class="col-lg-5 mt-4">
          <div class="card h-100 p-3">
            <h7 class="text-black  font-weight-bolder mb-3 ">
              <h7><i>ID Sekolah </i>: </h7>{{$row->id}}
            </h7>
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
              <span class="mask bg-gradient-dark"><img src="{{asset('fotosekolah/'.$row->foto)}}" alt="" class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-2 pt-2">{{$row->nama}}</h5>
                <p class="text-white">{{$row->alamat}}</p>
                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/detail_sekolah/{{$row->id}}">
                  Read More
        ...
        @if(count($data))
        @else
        <h6 class="text-center mt-5" style="margin-right:80px;">~~~~ Data Sekolah Kosong ~~~~</h6>
        @endif
      </div>
    </div>
    {{$data->links()}}
