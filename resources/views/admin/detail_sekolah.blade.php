  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="/detail_sekolah/{{$data->id}}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-2">Home Sekolah</span>
          </a>
        </li>
        <li class="nav-item">
              ...
              <li class="nav-item ">
                ...
                <div class="collapse" id="profileExample" style="">
                  <ul class="nav nav-sm flex-column">
                    <li class="nav-item">
                      <a class="nav-link " href="/detail_kelas/{{$data->id}}">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page"><a href="tambah_sekolah">Tambah Sekolah</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Detail Sekolah</li>
          </ol>

          <h6 class="font-weight-bolder mb-0">Detail Sekolah {{$data->nama}}</h6>
          <h7 class="font-weight-bolder mb-0"><i>ID Sekolah </i>: {{$data->id}}</h7>
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4" id="navbar">
          ...
          <li class="nav-item px-3 d-flex align-items-center">
            <a href="/edit_data_sekolah/{{$data->id}}" class="nav-link text-body p-0">
              <i class="">Edit Data</i>
            </a>
          </li>
              ...
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <i class="text-lg opacity-10" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" weight="22" height="22">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                ...
                <div class="col-4 text-end">
                  <div class="icon icon-shape bg-gradient-primary shadow text-center border-radius-md">
                    <i class="text-lg opacity-10" aria-hidden="true"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" height="22" weight="22">
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-capitalize font-weight-bold">Total User Sekolah</p>
                    <h5 class="font-weight-bolder mb-0">
                      {{$all}}
    ...
    new Chart(ctx2, {
      ...
      data: {
        ...
        datasets: [{
            ...
            fill: true,
            data: [76, 90, 75, 50, 40, 300, 220, 500, 250, 400, 230, 500],
            maxBarThickness: 6
          ...
          },
          {
            ...
            fill: true,
            data: [34, 90, 89, 54, 30, 90, 40, 140, 290, 290, 340, 230, 400],
            maxBarThickness: 6
          },
        ],
      },
