...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
    ...
    <div class="collapse navbar-collapse w-auto ps ps--active-y" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link  active" href="/daftar_tugas_materi">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Tugas Materi</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Daftar Tugas Materi</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
      <div class="row">
        <div class="col-lg-4 mb-4" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/indo.png" class="img-fluid border-radius-lg"
                  style='height: 100%; width: 100%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Bahasa Indonesia</h5>
        ...
        <div class="col-lg-3 mb-4" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/math.png" class="img-fluid border-radius-lg"
                  style='height: 97%; width: 97%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Matematika</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
              </a>
            </div>
        ...
        <div class="col-lg-3 mb-4" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/english.jpg" class="img-fluid border-radius-lg"
                  style='height: 100%; width: 100%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Bahasa Inggris</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-3" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/fisika.jpg" class="img-fluid border-radius-lg"
                  style='height: 97%; width: 97%; sobject-fit: contain'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Fisika</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-4" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/kimia.png" class="img-fluid border-radius-lg"
                  style='height: 97%; width: 97%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Kimia</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-4" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/olahraga.png" class="img-fluid border-radius-lg"
                  style='height: 97%; width: 97%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Olahraga</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-3" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/pkn.jpg" class="img-fluid border-radius-lg"
                  style='height: 95%; width: 95%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">PPKN</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-3" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/budaya.jpg" class="img-fluid border-radius-lg"
                  style='height: 100%; width:100%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Seni Budaya</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
        ...
        <div class="col-lg-3 mb-3" style="width: 20rem;">
          <div class="card">
            <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1 border-radius-lg">
              <!-- <span class="mask bg-gradient-dark border-radius-lg"> <h5 class="text-white font-weight-bolder mb-4 pt-2">Matematika</h5></span> -->
              <a href="javascript:;" class="d-block">
                <img src="../assets/img/mapel/agama.png" class="img-fluid border-radius-lg"
                  style='height: 100%; width: 100%;'>
              </a>
            </div>

            <div class="card-body pt-2">
              <h5 class="text-black font-weight-bolder mb-4 pt-2">Agama</h5>
              <a class="text-black text-sm font-weight-bold mb-0 icon-move-right mt-auto"
                href="../pages/buka_tugas.html">
                Lihat Tugas
                <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
