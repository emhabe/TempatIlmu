      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_mapel_siswa">Daftar
                Mapel</a></li>
            ...
            <div class="card-body px-0 pt-0 pb-2">
              <div class="table-responsive p-0">
                <table class="table align-items-center mb-0">
                  <thead>
                    <tr>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-1000">Bab</th>
                      <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-1000">Judul</th>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="d-flex px-2 py-1 text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Cerpen</h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <a href="/lihat_materi_siswa" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Pelajari Bab
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1 text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm text-center">II</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="d-flex px-2 py-1 text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Pantun</h6>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        <a href="../pages/lihat_materi.html" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Pelajari Bab
                        </a>
                      </td>
                    </tr>
