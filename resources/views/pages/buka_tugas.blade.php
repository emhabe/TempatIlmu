      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_tugas_materi">Daftar Tugas Materi</a></li>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td>
                        <div class="text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Membuat Cerpen</h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        ...
                        <a href="/lihat_tugas_siswa" class="text-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View Tugas
                        </a>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1 text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Teks Prosedur</h6>
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="text-center">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">Mengamati Teks Prosedur</h6>
                          </div>
                        </div>
                      </td>
                      <td class="align-middle text-center">
                      ...
                      <td class="align-middle text-center">
                        ...
                        <a href="../pages/lihat_tugas.html" class="text-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View Tugas
                        </a>
                      </td>
                    </tr>
