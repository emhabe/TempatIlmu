      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/buka_tugas">Tugas</a>
            </li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Lihat Tugas</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Lihat Tugas Bahasa Indonesia</h6>
        </nav>
      ...
      <div class="row">
        <div class="card pt-3 col-lg-7">
          <div class="row">
            ...
            <div class="mainwrapper">
              ...
              <div class="overlay" id="gambar-1">
                ...
                <iframe src="../assets/codeigniter_tutorial.pdf" width="100%" height="100%">
                </iframe>
              </div>
            </div>
          ...
          <div class="form-group mb-3">
            <input class="form-control" type="file" id="foto_mapel" name="bab_file">
          </div>
          <p>
          <div class="col-lg-6">
