      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_tugas_siswa">Daftar
                Tugas</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tugas</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tugas</h6>
        </nav>
          ...
          <div class="col-lg-4">
            <div class="card shadow-sm">
              <div class="card-header bg-transparent text-center">
                <img class="profile_img" src="../assets/img/team-2.jpg" alt="student dp">
                <h3>Andre</h3>
                <p>ans7@gmail.com</p>
              </div>
            </div>
          ...
          <div class="col-lg-8">
            <div class="card shadow-sm">
              <div class="card-header bg-transparent border-0">
                <h3 class="mb-0"><i></i>Detail Tugas</h3>
              </div>
              <div class="card-body pt-0">
                <ul class="list-group">
                  <li class="list-group-item border-0 ps-0 pt-0 text"><strong class="text-dark">Nama:</strong>
                    &nbsp; Andre</li>
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Kelas:</strong> &nbsp;
                    X RPL</li>
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Mapel:</strong> &nbsp;
                    Pemrograman Web</li>
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Tugas Yang Diberikan:</strong> &nbsp;
                    <p>
                    <div class="main">
                      <div class="thum">
                        <a href="#gambar-2">
                          <button class="btn btn-icon btn-3 btn bg-gradient-primary col-lg-4" type="button">
                            <span class="btn-inner--icon"><i class="fa-solid fa-file-pdf fa-2x fa-pull-left fa-bounce"></i></span>
                            <span class="btn-inner--text">PHP Dasar.pdf</span>
                          </button>
                        </a>
                      </div>
                      <div class="pop" id="gambar-2">
                        <div>
                          <a href="" class="close">
                        ...
                        <embed src="../assets/PHP Dasar Tutorial.pdf" width="100%" height="100%" />
                      </div>

                    </div>
                    
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Tugas Yang DIserahkan:</strong> &nbsp;
                    <p>
                    @foreach($datatugas as $row)
                    <a href="{{asset('storage_tugas/'.$row->upload_tugas)}}" data-lightbox="roadtrip">
                    <img src="{{asset('storage_tugas/'.$row->upload_tugas)}}" width="20%" height="20%" data-lightbox="roadtrip">
                    </a>
                    @endforeach
                    </p>
                  </li>
                  
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Status:</strong> &nbsp;
                    Mengumpulkan</li>
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Tanggal
                      Pengumpulan:</strong> &nbsp;
                    10-09-2022</li>
                  <li class="list-group-item border-0 ps-0 text"><strong class="text-dark">Nilai :</strong> &nbsp;
                    90</li>
                </ul>
              </div>
            </div>
