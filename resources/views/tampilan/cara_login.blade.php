...
<div class="wrapper">
    ...
    <div class="section section-map">
        ...
        <b><h4 class="title-section"><span class="text-info">1.Register</span></h4></b>
        <b><p class="desc">
            Siswa & Guru yang belum memiliki akun harus  <a href="/sign_up_siswa" class="footer-dua">Register</a>
            terlebiih dahulu dengan mengisikan data seperti NIP,NISN, Nama, Id Sekolah, dan lain-lain. </b>
        </p>
        ...
        <b><h4 class="title-section"><span class="text-success">3.Selesai</span></h4></b>
        <b><p class="desc">
