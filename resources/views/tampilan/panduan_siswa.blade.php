...
<div class="wrapper">
    ...
    <div class="section section-map">
        ...
        <b><h4 class="title-section"><span class="text-danger">1.Register</span></h4></b>
        <b><p class="desc">
            Siswa <a href="/sign_up_siswa" class="footer-dua">Register</a>
            dengan mengisikan data siswa seperti NISN, Nama, Id Sekolah, dan lain-lain. </b>
        </p>
        <b><h4 class="title-section"><span class="text-warning">2.Login</h4></b>
        <b><p class="desc">
            Jika sudah berhasil Register atau sudah mempunyai akun, Siswa dapat <a href="/sign_in_siswa" class="footer-dua">Login</a>
            sebagai user siswa.Dengan memasukan NISN , Nama, Id Sekolah, dan lain-lain, seperti saat Register tadi, setelah diisi akan langsung login sebagai user Siswa.</b>
        </p>
        <b><h4 class="title-section"><span class="text-info">3.Fitur</span></h4></b>
           <h6 class="desc">
