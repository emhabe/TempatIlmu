...
<div class="wrapper">
    ...
    <div class="section section-map">
        ...
        <b><p class="desc">
            Telah diciptakan sebuah Platform Belajar kekinian yang bernama Ruang Belajar. Aplikasi yang diluncurkan oleh Hummasoft Technology ini tak luput dari campur tangan para Progammer Muda yang bekerja disana. </b>
        </p>
        <b><p class="desc">
            Aplikasi ini dibuat berdasarkan hasil survei tim yang ada di lapangan. Dengan kondisi yang ada seperti ini kami membuat aplikasi ini tentunya agar bermanfaat bagi orang-orang sekitar dan juga mudah di akses, serta nyaman digunakan.</b>
        </p>
        <b><p class="desc">
            Kami membuat bertujuan agar aplikasi ini pada nantinya dapat diakses dengan sangat mudah oleh para pengguna. Tentunya fitur-fitur menarik lain akan memudahkan user atau pengguna untuk mengakses. </b>
        </p>
        <b><p class="desc">
            Tunggu apalagi..? Segeralah  <a href="/sign_in_siswa" class="footer-dua">Bergabung</a> bersama kami di RuangBelajar !</b>
        </p>
