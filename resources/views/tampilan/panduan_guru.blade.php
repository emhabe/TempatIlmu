...
<div class="wrapper">
    ...
    <div class="section section-map">
        ...
        <b><p class="desc">
            ...
            dengan mengisikan data guru seperti NIP, Nama, Id Sekolah, dan lain-lain. </b>
        </p>
        <b><h4 class="title-section"><span class="text-warning">2.Login</span></h4></b>
        <b><p class="desc">
            Jika sudah berhasil Register atau sudah mempunyai akun, Guru dapat  <a href="/sign_in_guru" class="footer-dua">Login</a>
            sebagai user Guru.Dengan memasukan ID Sekolah , email dan password, setelah diisi akan langsung login sebagai user Guru.</b>
        </p>
