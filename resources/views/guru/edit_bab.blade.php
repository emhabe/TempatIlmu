...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_mapel_guru">Daftar
                Mapel</a></li>
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_bab/{{$data->mapel_id}}">Daftar Bab</a>
            </li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Bab</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Bab</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <form action="/update_bab/{{$data->id}}" method="post" enctype="multipart/form-data">
      @csrf
            ...
            <div class="card">
              <div class="card-body pt-2">
                <div class="form-group">
                  <input type="text" name="mapel_id" value="{{$data->mapel->id}}" hidden>
                  <label for="exampleFormControlInput1">Judul Bab :</label>
                  <input type="text" class="form-control" id="judul" name="judul" value="{{$data->judul}}" placeholder="Masukkan Judul">
                </div>
                <div class="form-group">
                  <label for="exampleFormControlTextarea1">Deskripsi :</label>
                  <textarea class="form-control " id="deskripsi" name="deskripsi" rows="2" placeholder="Masukkan Deskripsi">{{$data->deskripsi}}</textarea>
                </div>
                <div class="mb-3">
                  <label >Masukkan File :</label>
                  <input type="file" name="bab_file" class="form-control" id="bab_file">
                </div>
                <embed type="application/pdf" src="{{asset('Bab/'.$data->bab_file)}}" width="600" height="200"></embed>
              </div>
              <div class="" style="margin-left: 10px;">
                <a href="Kirim Bab:;"><button type="submit" class="btn bg-gradient-success btn-tooltip btn-outline" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-container="body" data-animation="true" data-bs-original-title="Kirimkan Bab">
