...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_mapel">Daftar Mapel</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Mapel</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Mapel</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <form action="/insert_mapel" method="post" enctype="multipart/form-data">
    @csrf
          ...
          <div class="card">
            <div class="card-body pt-2">
                <div class="form-group">
                  <label for="exampleFormControlInput1">Nama Mapel Pelajaran</label>
                  <input type="text" class="form-control" id="nama_mapel" placeholder="Masukkan Nama Mata Pelajaran" name="nama_mapel">
                </div>
                <div class="form-group">
                  <label for="exampleFormControlTextarea1">Deskripsi Mata Pelajaran</label>
                ...
                <div class="mb-3">
              <label for="exampleFormControlInput1">Foto Mata Pelajaran :</label>
              ...
              <div class="" style="margin-left: 10px;">
                ...
                data-bs-toggle="tooltip" data-bs-placement="top" title="" data-container="body" data-animation="true" data-bs-original-title="Kirimkan Bab">
                  <span class="btn-inner--text">Buat Mapel </span>
