                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="align-middle text-center">
                        <a href="/edit_bab/{{$row->id}}" class="text-warning font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          Edit Bab
                        </a>
                      </td>
                      <td class="align-middle text-center">
                        <a href="/tugas_guru/{{$row->id}}" class="text-success font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View Bab
                        </a>
                      </td>
                      <td class="align-middle text-center">
