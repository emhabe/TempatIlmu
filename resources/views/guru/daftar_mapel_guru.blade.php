...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    ...
    <div class="container-fluid py-3">
      <div class="row">
        <div>
          <a href="#" type="button" class="btn bg-gradient-primary mt-5 mx-4" data-bs-toggle="modal" data-bs-target="#modal-insert">Tambah Mata Pelajaran
        ...
        <div class="col-12 col-lg-4">
            ...
            <div class="card-body pb-0">
              <div class="row align-items-center mb-3">
                <div class="d-flex">
                  ...
                  <div class="ms-auto">
                    <div class="dropstart">
                      ...
                      <ul class="dropdown-menu dropdown-menu-lg-start px-2 py-3" aria-labelledby="dropdownMarketingCard" style="">
                        <li><a class="dropdown-item border-radius-md font-weight-bolder text-info" href="javascript:;" data-bs-toggle="modal" data-bs-target="#modal-update{{$row->id}}">Edit Mapel</a></li>
                        <li><a class="dropdown-item border-radius-md text-success font-weight-bolder icon-move-right" href="/daftar_bab/{{$row->id}}">See Details<i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i></a></li>
                        <li>
                ...
                <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
                  <span class="mask bg-gradient-dark"><img src="{{asset('Mapel/'.$row->foto_mapel)}}" alt="" class="mask bg-gradient-dark"></span>
                  <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                    <h5 class="text-white font-weight-bolder mb-4 pt-2">{{$row->nama_mapel}}</h5>
                    <p class="text-white">{{$row->deskripsi_mapel}}</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4">
            <div class="modal fade" id="modal-update{{$row->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-form" aria-hidden="true">
              <div class="modal-dialog modal-dialog-centered modal-m" role="document">
                <div class="modal-content">
                  <div class="modal-body p-0">
                    <div class="card card-plain">
                      <div class="card-header pb-0 text-left">
                        <h3 class="font-weight-bolder text-info text-gradient">Edit Mapel</h3>
                      </div>
                      <div class="card-body">
                        <form role="form text-left" action="/update_mapel/{{$row->id}}" method="post" enctype="multipart/form-data">
                          ...
                          <div class="text-left"><img src="{{asset('Mapel/'.$row->foto_mapel)}}" alt="" style="width: 150px;"></div>
  ...
  <script>
    $('.delete').click(function() {
      ...
      swal({
        ...
        .then((willDelete) => {
          if (willDelete) {
            window.location = "/delete_mapel/" + idmapel + ""
