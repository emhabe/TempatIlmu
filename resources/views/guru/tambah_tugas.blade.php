...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/tugas_guru/{{$data->id}}">Tugas</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Tugas</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Tugas</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <form action="/insert_tugas/{{$data->id}}" method="post" enctype="multipart/form-data">
      @csrf
            ...
            <div class="card">
              <div class="card-body pt-2">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control " id="deskripsi_tugas" name="deskripsi_tugas" rows="2"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  <div class="mb-3">
                    ...
                    <input class="form-control" type="file" id="file_tugas" name="file_tugas" multiple required>
                  </div>
                </div>
                <div class="" style="margin-left: 10px;">
                  <a href="javascript:;"><button type="submit" class="btn bg-gradient-success btn-tooltip btn-outline" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-container="body" data-animation="true" data-bs-original-title="Kirimkan Tugas">
