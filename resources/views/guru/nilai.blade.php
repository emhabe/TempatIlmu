      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/kelas">Pengumpulan</a>
            </li>
    ...
    <div class="card-body">
      <form role="form text-left">
        <div class="mb-3 col-9">
          <label>Nama</label>
          <input type="text" class="form-control" aria-label="Name" aria-describedby="email-addon" placeholder="Hafill"
            disabled>
        </div>
        <div class="mb-3 col-9">
          <label>Mapel</label>
          <input type="text" class="form-control" aria-label="Name" aria-describedby="email-addon"
            placeholder="Bahasa Indonesia" disabled>
        </div>
        <div>
          <p><label>Tugas :</label></p>
          <p>
        ...
        <div class="form-group col-9">
          <label for="example-date-input" class="form-control-label">Tanggal Pengumpulan :</label>
          <input class="form-control" type="date" value="2022-09-10" id="example-date-input" disabled>
        </div>

        <div class="mb-3 col-9">
          <label>Nilai</label>
          <input type="text" class="form-control" placeholder="Beri Nilai" aria-label="Password"
            aria-describedby="password-addon">
        </div>
        <div class="form-group col-9">
          <label for="exampleFormControlTextarea1">Komentar</label>
          <textarea class="form-control" placeholder="Catatan Untuk Siswa" id="exampleFormControlTextarea1"
            rows="3"></textarea>
        </div>
