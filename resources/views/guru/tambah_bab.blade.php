...
<body class="g-sidenav-show  bg-gray-100">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Tambah Bab</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Tambah Bab</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <form action="/insert_bab/{{$datamapel->id}}" method="post" enctype="multipart/form-data">
      @csrf
          ...
          <div class="col-9">
            <div class="card">
              <div class="card-body pt-2">
                ...
                <div class="mb-3">
                  <label for="exampleFormControlInput1">File Bab :</label>
                  <input class="form-control" type="file" id="bab_file" name="bab_file" placeholder="Masukkan File" required>
                </div>
