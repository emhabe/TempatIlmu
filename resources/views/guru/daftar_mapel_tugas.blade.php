...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
    ...
    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 303px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 246px;"></div></div></div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/daftar_tugas_guru">Daftar Tugas Kelas</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Daftar Tugas Mapel</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Daftar Tugas Mapel</h6>
        </nav>
    ...
    <div class="container-fluid py-4">
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                ...
                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/lihat_tugas_guru/{{$row->id}}">
                  View Class
      ...
      @if(count($datamapel))
                        @else
                        <h6 class="text-center" style="margin-right:80px;">~~~~ Data Mapel Kosong ~~~~</h6>
                       @endif
    </div>
    {{$datamapel->links()}}
