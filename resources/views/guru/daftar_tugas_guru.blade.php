    ...
    <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl position-sticky blur shadow-blur mt-4 left-auto top-1 z-index-sticky" id="navbarBlur" navbar-scroll="true">
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          ...
          <h6 class="font-weight-bolder mb-0">Daftar Tugas Siswa</h6>
        </nav>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">X RPL</h5>
                <p>
                  <h7 class="text-white font-weight-bolder mb-4 pt-2">Wali Kelas : Slatem</h7>
                </p>
                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="/daftar_mapel_tugas">
                  View Class
        ...
        <div class="col-lg-4 mb-3">
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
              <span class="mask bg-gradient-dark"></span>
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                <h5 class="text-white font-weight-bolder mb-4 pt-2">XI RPL</h5>
                <p>
                  <h7 class="text-white font-weight-bolder mb-4 pt-2">Wali Kelas : Toha</h7>
                </p>
          ...
          <div class="card h-100 p-3">
            <div class="overflow-hidden position-relative border-radius-lg bg-cover h-100">
              ...
              <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
                ...
                <p>
                  <h7 class="text-white font-weight-bolder mb-4 pt-2">Wali Kelas : Pendik</h7>
                </p>
                <a class="text-white text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="materi.html">
                  View Class
                  <i class="fas fa-arrow-right text-sm ms-1" aria-hidden="true"></i>
