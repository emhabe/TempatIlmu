                ...
                <table class="table align-items-center mb-0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>
                        <div class="d-flex px-2 py-1">
                          <div class="align-middle  d-flex flex-column justify-content-center">
                            <h6 class="mb-0 text-sm">{{$index+$data->FirstItem()}}. {{$row->judul}}</h6>
                          </div>
                        </div>
                      </td>
                      ...
                      <td class="align-middle text-center">
                        <a href="/kelas" class="text-info font-weight-bold text-xs" data-toggle="tooltip" data-original-title="Edit user">
                          View Kelas
                        </a>
                      </td>
                    </tr>
