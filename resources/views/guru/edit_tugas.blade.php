...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 ps bg-white" id="sidenav-main">
    ...
    <div class="ps__rail-x" style="left: 0px; bottom: 0px;"><div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div></div><div class="ps__rail-y" style="top: 0px; height: 303px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 289px;"></div></div></div>
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
      ...
      <div class="container-fluid py-1 px-3">
        <nav aria-label="breadcrumb">
          <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
            ...
            <li class="breadcrumb-item text-sm"><a class="opacity-5 text-dark" href="/tugas_guru/{{$datatugas->bab_id}}">Tugas</a></li>
            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Edit Tugas</li>
          </ol>
          <h6 class="font-weight-bolder mb-0">Edit Tugas</h6>
        </nav>
    ...
    <!-- End Navbar -->
    <form action="/update_tugas/{{$datatugas->id}}" method="post" enctype="multipart/form-data">
      @csrf
            ...
            <div class="card">
              <div class="card-body pt-2">
                <div class="form-group">
                  <input type="text" name="bab_id" value="{{$datatugas->bab->id}}" hidden>
                  <label for="exampleFormControlInput1">Judul Tugas</label>
                  <input type="text" class="form-control" id="nama_tugas" placeholder="" name="nama_tugas" value="{{$datatugas->nama_tugas}}">
                </div>
                <div class="form-group">
                  <label for="exampleFormControlTextarea1">Deskripsi</label>
                  <textarea class="form-control " id="deskripsi_tugas" name="deskripsi_tugas" rows="2">{{$datatugas->deskripsi_tugas}}</textarea>
                </div>
                <div class="form-group">
                  <label for="example-datetime-local-input" class="form-control-label">Tenggat Tugas </label>
                  <input class="form-control form-control-sm" type="datetime-local" id="tenggat" name="tenggat" value="{{$datatugas->tenggat}}">
                </div>
                <div class="form-group">
                  <div class="mb-3">
                  ...
                  <embed type="application/pdf" src="{{asset('Tugas/'.$datatugas->file_tugas)}}" width="600" height="200"></embed>
                </div>
                <div class="" style="margin-left: 10px;">
                  <a href="javascript:;"><button type="submit" class="btn bg-gradient-success btn-tooltip btn-outline" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-container="body" data-animation="true" data-bs-original-title="Update Tugas">
                      <span class="btn-inner--text">UPDATE</span>
                      <span class="btn-inner--icon"><i class="ni ni-send"></i></span></button></a>
                </div>
              </div>
